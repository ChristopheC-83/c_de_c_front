...
export default function CardProject({ project }: CardProject) {
  ...
  return (
    <Link href={`/projects/${project.id}`} className="flex flex-col w-full justify-center lg:justify-start border-2 border-ring rounded-lg bg-card text-card-foreground mt-8 p-1.5 xs:p-2 sm:p-3 md:p-4 customShadow">
