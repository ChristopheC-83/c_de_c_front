...
return (
    <div className="container">
      <h2 className="text-center clip mb-8 w-fit mx-auto">Choisis ton langage :</h2>
        <div className="flex">
            {langagesToChoose.map((langage) => (
                <div key={langage.id} className="flexMid justify-between w-full px-2 ">
                        {/* <h4>{langage.name}</h4> */}
                        ...
                        <Image src={langage.logo} alt={langage.name} fill className="object-contain "/>
                        </div>
                </div>
            ))}
        </div>
