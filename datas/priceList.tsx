...
export const priceList: PriceListType[] = [
  {
    ...
    text: (
      <>
        ...
        Faites vous connaitre et <b>augmentez votre chiffre d'affaire</b> ! <br/>
        Un site vitrine pour<b> exposer vos services et vos réalisations.</b>
        <br />
        Un site moderne, <b>adaptable et optimisé</b> pour les ordinateurs, tablettes
        et smartphones.
        <br />
      </>
  ...
  {
    id: 2,
    price: "A partir de 2500€",
    label: "Un projet administrable pour le gérer.",
    text: (
      <>
        Gérer votre business en toute autonomie avec cette suite.<br/>
        Un site vitrine pour<b> booster votre CA</b> en mettant en avant votre business.<br/>
        Un site back-office pour<b> gérer vos données (articles, prestations, clients...)</b> .<br/>
        Les 2 sont liés ! <br/>
        Une proposition dans le back alimente instantannéement le site vitrine !<br/>
        <b>Restez à jour !</b>
      </>
    ),
  },
  {
    id: 3,
    price: "A déterminer...(450€/jour environ)",
