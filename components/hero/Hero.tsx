...
export default function Hero() {
  return (
    <div className="container flex flex-col sm:flex-row-reverse justify-center sm:justify-between sm:items-center gap-8">
      <div className="flex items-center justify-center sm:justify-end">
        <Image
          ...
          width={250}
          height={250}
          className="rounded-full object-contain border-2 border-primary bg-gradient-to-bl from-indigo-700 to-slate-700 shadow"
        />
      </div>
      <div className="w-full sm:w-3/4 mx-auto h-fit border-2 border-primary p-1.5 xs:p-2 sm:p-3 flex flex-col gap-y-8 rounded">
